...
- generated_at: `2026-05-25T07:46:04`
- source_file: `E:\智能體\城城城程式\data\knowledge_hub\aeg_keyword_graph.json`
- sources_seen: `3`
- text_items: `3362`
- keywords_count: `120`

## Completeness Check
- readable_keywords: `120/120` (100.0%)
- suspected_garbled_keywords: `0`
...
17. `回退到總管單 <-> 總管` (69)
18. `一路由 <-> 總管` (69)
19. `langgraph <-> 尚未可用` (69)
20. `langgraph <-> 回退到總管單` (69)
21. `langgraph <-> 一路由` (69)
22. `尚未可用 <-> 路由角色` (69)
23. `回退到總管單 <-> 路由角色` (69)
24. `一路由 <-> 路由角色` (69)
